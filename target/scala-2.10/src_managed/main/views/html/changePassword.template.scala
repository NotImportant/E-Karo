...
<html>
    ...
    <body>
        ...
        """),_display_(Seq[Any](/*15.10*/helper/*15.16*/.form(routes.Application.authenticateChangePassword)/*15.68*/ {_display_(Seq[Any](format.raw/*15.70*/("""
            ...
            Do not have an account? <a href=""""),_display_(Seq[Any](/*46.47*/routes/*46.53*/.Application.signup)),format.raw/*46.72*/("""" id="register">Sign Up </a> here!           
        """)))})),format.raw/*47.10*/("""
