...
<li data-task-id=""""),_display_(Seq[Any](/*3.20*/task/*3.24*/.id)),format.raw/*3.27*/("""">
    ...
    """),_display_(Seq[Any](/*15.6*/if(task.assignedTo != null && task.assignedTo.username != null)/*15.69*/ {_display_(Seq[Any](format.raw/*15.71*/("""
        <span class="assignedTo">"""),_display_(Seq[Any](/*16.35*/task/*16.39*/.assignedTo.username)),format.raw/*16.59*/("""</span>
    """)))})),format.raw/*17.6*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Sun May 11 18:21:39 EDT 2014
                    SOURCE: /Users/tituschirchir/E-Karo/E-Karo/app/views/tasks/item.scala.html
                    HASH: 83243c7ecd998d1a18a7e250f24f44a3e65bbcef
                    MATRIX: 785->1|919->41|975->62|987->66|1011->69|1058->82|1080->96|1119->98|1200->144|1246->169|1285->178|1335->193|1347->197|1374->203|1425->219|1458->243|1498->245|1560->271|1573->275|1603->283|1642->286|1655->290|1707->320|1751->333|1797->344|1869->407|1909->409|1980->444|1993->448|2035->468|2079->481|2125->492|2148->506|2188->508|2262->546|2277->552|2321->574|2419->641
